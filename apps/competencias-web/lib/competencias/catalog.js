...
import {
  ...
  ANCORAS,
  ANCORADOS,
  ANCORADOS_EM_RASCUNHO,
  SEM_ANCORADOS_COMPLETOS,
  FAIXAS,
  LEITURA_FAIXA,
...
export {
  ...
  COMPETENCIAS, BLOCOS, BANCO_ITENS, ANCORAS, ANCORADOS,
  ANCORADOS_EM_RASCUNHO, SEM_ANCORADOS_COMPLETOS,
  FAIXAS, LEITURA_FAIXA,
};
