  ...
  return (
    <section>
      ...
      <LegendSection titulo="Futuro">
        <Campo id="s6_o_que_gostaria" label={<>30. Existe algo que você gostaria de encontrar com {marca} e que ainda não oferecemos?</>}>
      ...
      <LegendSection titulo="Recomendação">
        <Campo label={<>31. De 0 a 10, o quanto você recomendaria {marca} para um amigo ou familiar? <RequiredMark/></>}
          erro={erros.s6_nps}>
          <EscalaSlider name="s6_nps" value={dados.s6_nps} onChange={v => atualizar('s6_nps', v)} />
        </Campo>

        <Campo id="s6_nps_porque" label={<>32. Por quê? <RequiredMark/></>}
