  ...
  return (
    <section>
      ...
      <LegendSection titulo="Canais de contato">
        <Campo label={<>15. Por quais canais você já interagiu com {marca}? <RequiredMark/></>}
      ...
      <LegendSection titulo="Qualidade do atendimento (0-10)">
        <p style={{ fontSize: '0.88rem', color: 'var(--text-secondary)', marginTop: 0 }}>
          16. De 0 a 10, como você avalia nosso atendimento nos seguintes quesitos?
      ...
      <LegendSection titulo="Diferenças e última comunicação">
        <Campo id="s3_diferenca_real" label="17. Em qual desses itens você viu diferença real vs outros lugares que já usou?">
          <TextArea id="s3_diferenca_real" value={dados.s3_diferenca_real} onChange={v => atualizar('s3_diferenca_real', v)} rows={3} />
        </Campo>

        <Campo id="s3_ultima_comunicacao" label="18. Qual foi a última vez que você viu algo da marca nos canais (redes, WhatsApp, site, e-mail)? O que você lembra?">
