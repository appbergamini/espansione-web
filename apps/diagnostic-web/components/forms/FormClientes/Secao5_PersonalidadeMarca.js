  ...
  return (
    <section>
      ...
      <LegendSection titulo="Identidade simbólica">
        <Campo id="s5_marca_pessoa" label={<>26. Se {marca} fosse uma pessoa, como você descreveria a personalidade dela?</>}
        ...
        <Campo id="s5_apresentaria_amigo" label={<>27. Como você apresentaria {marca} para um amigo em poucas palavras?</>}>
          <TextArea id="s5_apresentaria_amigo" value={dados.s5_apresentaria_amigo} onChange={v => atualizar('s5_apresentaria_amigo', v)} rows={3} />
        </Campo>

        <Campo id="s5_vale_a_pena" label="28. Se um amigo te perguntasse &ldquo;vale a pena?&rdquo;, o que você responderia em 2 frases?">
          <TextArea id="s5_vale_a_pena" value={dados.s5_vale_a_pena} onChange={v => atualizar('s5_vale_a_pena', v)} rows={3} />
        </Campo>

        <Campo id="s5_palavra_proibida" label="29. Qual palavra você nunca usaria para descrever essa marca?">
        ...
        <Campo id="s5_marca_uma_palavra" label={<>30. Defina {marca} em uma única palavra. <RequiredMark/></>}
