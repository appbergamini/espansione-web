...
// Setup self-serve do Mapa do Crescimento Integrado · Estratégico após a compra (redirect do checkout).
...
export default function IdentidadeSetup() {
  ...
  return (
    <MapaShell title="Configurar o Mapa do Crescimento Integrado · Estratégico · Espansione">
        ...
        {fase === 'aguardando' && (
          <Card>
            ...
            <h1 style={sx.h1}>Preparando o seu Mapa do Crescimento Integrado · Estratégico…</h1>
        ...
        {fase === 'pronto' && dados && (
          ...
          <Card wide>
            <div style={sx.accent} />
            <div style={sx.eyebrow}>Mapa do Crescimento Integrado · Estratégico · configurado</div>
            <h1 style={sx.h1}>Tudo pronto{dados.cliente ? `, ${dados.cliente}` : ''}!</h1>
            <p style={sx.txt}>
              O Mapa do Crescimento Integrado · Estratégico cruza <b>três olhares</b> sobre a sua empresa. Compartilhe cada link com
