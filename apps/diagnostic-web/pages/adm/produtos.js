...
const FULFILLMENTS = [
  { v: 'identidade', label: 'Mapa de Identidade (cria assessment + 3 links)' },
      ...
      <div className="page-container"><main className="container">
        ...
        <div className="glass-card" style={{ marginBottom: '1.4rem' }}>
          ...
          <div style={sx.grid}>
            ...
            <label style={sx.lbl}>Nome (aparece no checkout) <input value={form.nome} onChange={(e) => setForm({ ...form, nome: e.target.value })} placeholder="Mapa de Identidade Estratégica" style={sx.inp} /></label>
