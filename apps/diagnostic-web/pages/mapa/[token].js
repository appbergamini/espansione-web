...
// =====================================================================
// Mapa do Crescimento Integrado (FINAL) — página pública (acesso por token).
    ...
    <MapaShell>
        ...
        {fase === 'cadastro' && (
          <Card wide>
            ...
            <p style={sx.txtSec}>
              O Mapa do Crescimento Integrado é um check-up rápido do seu negócio. Preencha seus dados para
        ...
        {fase === 'gerando' && (
          <Card>
            ...
            <p style={sx.txtSec}>Estamos preparando a leitura completa do seu Mapa do Crescimento Integrado. Leva alguns segundos.</p>
