...
// Body: { projeto_id }
// Cria/recupera a avaliação do Mapa de Identidade (instrumento completo e
// independente do Mapa de Maturidade) e devolve os 3 links (Sócios, Equipe,
// Externo) + status. O Mapa de Maturidade é outro módulo (lib/mapa-maturidade).
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (!a) {
      const ins = { projeto_id, produto: 'identidade_pago', status: 'not_started', socios_token: tk(), colaboradores_token: tk(), clientes_token: tk() };
