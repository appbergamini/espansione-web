// POST /api/identidade-v2/finalize — PÚBLICO, por token (+ rid p/ multi-respondente)
// Valida obrigatórias, marca o respondente como concluído e recomputa o
// result_json do assessment (notas, gaps, eNPS/NPS, priorização) via engine.

import { supabaseAdmin } from '../../../lib/supabaseAdmin';
import { montarFormulario, obrigatoriasFaltando } from '../../../lib/identidade-v2/forms';
import { montarResultado } from '../../../lib/identidade-v2/scoring';
...
export default async function handler(req, res) {
  ...
  // respondente: sócios = único; outros = rid
  ...
  try {
    // respostas do respondente atual → validar obrigatórias
    ...
    console.error('[identidade-v2/finalize]', e);
