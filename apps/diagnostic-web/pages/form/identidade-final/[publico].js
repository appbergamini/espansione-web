...
// Formulário genérico do Mapa de Identidade (FINAL), dirigido pelo catálogo.
  ...
  return (
    <>
      ...
      <div style={sx.page}>
        ...
        {fase === 'form' && (
          <Card wide>
            <div style={sx.eyebrow}>Mapa de Identidade Estratégica{publico ? ` · ${TITULO[publico] || publico}` : ''}</div>
