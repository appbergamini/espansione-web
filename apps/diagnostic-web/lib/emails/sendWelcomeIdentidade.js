...
// E-mail de boas-vindas + instruções, disparado após a compra do Mapa do Crescimento Integrado Estratégico.
export async function sendWelcomeIdentidade({ to, nome, baseUrl, links = [], setupUrl }) {
  ...
  const { data, error } = await resend.emails.send({
    from,
    to,
    subject: 'Bem-vindo ao Mapa do Crescimento Integrado Estratégico 🎉',
    html: `
      <div style="font-family:-apple-system,Segoe UI,Roboto,sans-serif;max-width:560px;margin:0 auto;color:#334155">
        ...
        <div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:12px;padding:32px">
          ...
          <p style="font-size:14px;line-height:1.6;color:#475569;margin:0 0 20px">
            Sua compra do <strong>Mapa do Crescimento Integrado Estratégico</strong> foi confirmada. Ele cruza
