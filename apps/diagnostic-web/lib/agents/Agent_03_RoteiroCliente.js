import { AC_TRIPLICE, AC_INVESTIGACAO_SIMULTANEA, AC_ONDAS, AC_RDPC, AC_PRINCIPIOS, AC_REGRA_SEM_HTML, AC_REGRA_FINDINGS } from './_anaCoutoKB';
...
export const Agent_03_RoteiroCliente = {
  ...
  inputs: [2],
  checkpoint: null,
  // FIX.12 — getUserPrompt injeta previousOutputs[2] manualmente.
