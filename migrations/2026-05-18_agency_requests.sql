...
create table if not exists agency_requests (
  ...
  briefing_original_json jsonb,
  approved_briefing_json jsonb,
  briefing_source text check (briefing_source in ('ai', 'admin_edited')),
  briefing_revision_reason text,
  briefing_generated_at timestamptz,
  briefing_approved_at timestamptz,
  briefing_approved_by text,
