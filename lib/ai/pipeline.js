...
export const AGENT_CONFIGS = {
  ...
  2:  { name: 'Contexto Interno (VI)',                    stage: 'diagnostico_interno',  inputs: [1],           checkpoint: null },
  3:  { name: 'Roteiros VE — Entrevistas Cliente',        stage: 'diagnostico_externo',  inputs: [2],           checkpoint: null },
  4:  { name: 'Contexto Externo (VE)',                    stage: 'diagnostico_externo',  inputs: [3],           checkpoint: null },
  5:  { name: 'Pesquisa de Mercado (VM)',                 stage: 'diagnostico_externo',  inputs: [],            checkpoint: null },
  6:  { name: 'Decodificação de Valor e DE-PARA',         stage: 'sintese',              inputs: [2, 4, 5],     checkpoint: 1    },
