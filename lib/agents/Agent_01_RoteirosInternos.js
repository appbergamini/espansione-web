import { AC_TRIPLICE, AC_INVESTIGACAO_SIMULTANEA, AC_ONDAS, AC_PRINCIPIOS, PORTER_ESTRATEGIA } from './_anaCoutoKB';
...
export const Agent_01_RoteirosInternos = {
  ...
  getSystemPrompt() {
    return [
      ...
      '- Avalie posicionamento competitivo (Porter): o formulário revela sensibilidade às 5 Forças? A marca parece estar optando por qual das 3 Estratégias Genéricas (custo, diferenciação, foco)? Gere perguntas pra validar isso com sócios.',
      '',
