...
export const Agent_05_BuscaWeb = {
  ...
  async enrichContext(context) {
    ...
    // 1. Deep research via Claude (orçamento: 180s)
    ...
    try {
      research = await withTimeout(
        deepResearchViaClaude({
          contextoProjeto,
          // 6 buscas é o budget que cabe com folga em 180s (cada busca
          // via Claude Opus 4.7 + web_search ~15-25s em headless).
          maxBuscas: 6,
    ...
    // 3. Tavily Extract nos 5 principais (orçamento: 45s)
