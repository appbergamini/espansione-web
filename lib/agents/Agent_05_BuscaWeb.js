...
import { AC_PRINCIPIOS } from './_anaCoutoKB';
...
export const Agent_05_BuscaWeb = {
  ...
  async enrichContext(context) {
    ...
    // 1. Deep research via Claude
    console.log('[Agente 5 v2] Iniciando deep research via Claude web_search…');
    let research = null;
    try {
      research = await deepResearchViaClaude({
        contextoProjeto,
        // 18 buscas estouravam timeout (cada web_search ~10-15s via Claude
        // Opus 4.7 = 180-270s só de research). 10 cobre as 4 lentes do
        // método sem sacrificar profundidade significativa.
        maxBuscas: 10,
