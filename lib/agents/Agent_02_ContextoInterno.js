...
export const Agent_02_ContextoInterno = {
  ...
  getUserPrompt(context) {
    ...
    parts.push('  × inventar terceiros nomeados ("Fernando (COO)", "Eduardo", "o CFO João") mesmo quando descrever um pilar/função (ex.: o pilar Finanças é comentado sem atribuir dono a menos que ele conste desta lista)');
    ...
    parts.push('Qualquer nome fora desta lista = alucinação = compromete a devolutiva.');
    parts.push('════════════════════════════════════════════════════════════════');
    parts.push('');
