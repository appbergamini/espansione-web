...
export const Agent_02_ContextoInterno = {
  ...
  getSystemPrompt() {
    return [
      ...
      '- CIS com <70% de cobertura → declarar limitação na leitura comportamental coletiva.',
      '- Diagnóstico 360° com <80% respondido → declarar limitação na leitura de maturidade.',
