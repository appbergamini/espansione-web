...
export const Agent_06_VisaoGeral = {
  ...
  getUserPrompt(context) {
    ...
    const dumpOutput = (label, out) => {
      ...
      if (out.conteudo) parts.push(out.conteudo);
    ...
    dumpOutput('CONSOLIDADO VI (Output 2)', ctxVi);
    dumpOutput('CONSOLIDADO VE (Output 4)', ctxVe);
    dumpOutput('VM — VISÃO DE MERCADO (Output 5)', ctxVm);
