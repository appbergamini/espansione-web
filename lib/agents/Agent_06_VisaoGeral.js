import { AC_TRIPLICE, AC_MOMENTO, AC_RDPC, AC_ONDAS, AC_INVESTIGACAO_SIMULTANEA, AC_DE_PARA, AC_PRINCIPIOS } from './_anaCoutoKB';
...
export const Agent_06_VisaoGeral = {
  ...
  getSystemPrompt() {
    return [
      ...
      '',
      '6. AVALIAÇÃO RDPC CONSOLIDADA (cada critério com cor + justificativa em 2 frases).',
      '',
      '7. DECODIFICAÇÃO DE VALOR — TRÍPLICE CRUZADA (I+E+M):',
      '   - IMPULSIONADORES (bullets, marcados (I)(E)(M) conforme fonte)',
      '   - DETRATORES (bullets, marcados)',
      '   - ACELERADORES (bullets, marcados)',
      '',
      '8. DE-PARA ESTRATÉGICO:',
      '   NEGÓCIO — SAIR [retrato hoje] → IR [visão de futuro]',
      '   MARCA — SAIR → IR',
      '   COMUNICAÇÃO — SAIR → IR',
      '',
      '9. HIPÓTESES PARA OS AGENTES DE CONSTRUÇÃO (bullet) — o que cada próximo agente (Valores, Diretrizes, Plataforma, Verbal, Visual, Experiência, Comunicação) precisa validar, resolver ou desenvolver a partir deste diagnóstico.',
      '</conteudo>',
      '',
      '<conclusoes>',
